...
claude, codex, opencode, pi, grok, devin, and antigravity are all empirically verified; new harnesses get verified through a supervised trial task before joining the set.
