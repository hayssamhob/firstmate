...
The helper's 0600 per-task cache re-mints on demand, so tasks longer than the 1h token TTL keep authenticating; a successful injection records `foreman=` in task meta.
