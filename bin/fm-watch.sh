...
# antigravity (agy): "esc to cancel" (mid-turn footer hint, alongside a
# "Working.../Prioritizing Tool Usage..." braille spinner; idle footer is
# "? for shortcuts") - covered by the shared "esc (to )?(interrupt|cancel)" branch.
...
BUSY_REGEX=${FM_BUSY_REGEX:-'esc (to )?(interrupt|cancel)|Working\.\.\.|Ctrl\+c:cancel'}
